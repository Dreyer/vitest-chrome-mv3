...
describe('chrome.notifications', () => {
  ...
  test('onButtonClicked event interface works', () => {
    ...
    expect(chrome.notifications.onButtonClicked.hasListener(listener)).toBe(
      true,
    );
  ...
  test('onPermissionLevelChanged event interface works', () => {
    ...
    expect(
      chrome.notifications.onPermissionLevelChanged.hasListener(listener),
    ).toBe(true);
  ...
  test('onShowSettings event interface works', () => {
    ...
    expect(chrome.notifications.onShowSettings.hasListener(listener)).toBe(
      true,
    );
