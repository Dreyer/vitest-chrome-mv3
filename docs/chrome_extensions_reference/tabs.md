...
[language](https://developer.chrome.com/docs/extensions/reference/api/tabs#method-detectLanguage) of the tab, take a [screenshot](https://developer.chrome.com/docs/extensions/reference/api/tabs#method-captureVisibleTab), and
[communicate](https://developer.chrome.com/docs/extensions/reference/api/tabs#method-sendMessage) with a tab's content scripts.

## Permissions

<br />

Most features don't require any permissions to use. For example: [creating](https://developer.chrome.com/docs/extensions/reference/api/tabs#method-create) a new tab,
[reloading](https://developer.chrome.com/docs/extensions/reference/api/tabs#method-reload) a tab, [navigating](https://developer.chrome.com/docs/extensions/reference/api/tabs#method-update) to another URL, etc.
...
:   This permission does not give access to the `chrome.tabs` namespace. Instead, it
    grants an extension the ability to call [`tabs.query()`](https://developer.chrome.com/docs/extensions/reference/api/tabs#method-query) against four
    sensitive properties on [`tabs.Tab`](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-Tab) instances: `url`, `pendingUrl`, `title`, and
    `favIconUrl`.
...
:   [Host permissions](https://developer.chrome.com/docs/extensions/develop/concepts/declare-permissions) allow an extension to read and query a matching tab's four sensitive
    `tabs.Tab` properties. They can also interact directly with the matching tabs using methods such
    as [`tabs.captureVisibleTab()`](https://developer.chrome.com/docs/extensions/reference/api/tabs#method-captureVisibleTab),
    [`scripting.executeScript()`](https://developer.chrome.com/docs/extensions/reference/api/scripting#method-executeScript), [`scripting.insertCSS()`](https://developer.chrome.com/docs/extensions/reference/api/scripting#method-insertCSS), and
    [`scripting.removeCSS()`](https://developer.chrome.com/docs/extensions/reference/api/scripting#method-removeCSS).
...
:   [`activeTab`](https://developer.chrome.com/docs/extensions/develop/concepts/activeTab) grants an extension temporary host permission for the current tab in
...
| **Note:** This example doesn't require any [permissions](https://developer.chrome.com/docs/extensions/reference/api/tabs#perms).
...
#### Properties
  ...
  - reason  
  [MutedInfoReason](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-MutedInfoReason) optional
...
#### Properties
  ...
  - mutedInfo  
  [MutedInfo](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-MutedInfo) optional  
  Chrome 46+
  ...
  Please use [`tabs.Tab.highlighted`](https://developer.chrome.com/docs/extensions/reference/api/tabs#property-Tab-highlighted).
  ...
  - status  
  [TabStatus](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-TabStatus) optional
...
#### Properties
  ...
  - mode  
  [ZoomSettingsMode](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-ZoomSettingsMode) optional

  Defines how zoom changes are handled, i.e., which entity is responsible for the actual scaling of the page; defaults to `automatic`.
  - scope  
  [ZoomSettingsScope](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-ZoomSettingsScope) optional
...
The maximum number of times that [`captureVisibleTab`](https://developer.chrome.com/docs/extensions/reference/api/tabs#method-captureVisibleTab) can be called per second. [`captureVisibleTab`](https://developer.chrome.com/docs/extensions/reference/api/tabs#method-captureVisibleTab) is expensive and should not be called too often.  
...
): Promise<https://developer.chrome.com/docs/extensions/reference/api/tabs#type-Tab>
```
...
#### Returns
  ...
  - Promise\<[Tab](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-Tab)\>  
Chrome 88+  
...
chrome.tabs.discard(
  tabId?: number,
): Promise<https://developer.chrome.com/docs/extensions/reference/api/tabs#type-Tab | undefined>
```
...
#### Returns
  ...
  - Promise\<[Tab](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-Tab) \| undefined\>  
Chrome 88+  
...
```typescript
chrome.tabs.getCurrent(): Promise<https://developer.chrome.com/docs/extensions/reference/api/tabs#type-Tab | undefined>
```
...
  tabId?: number,
): Promise<https://developer.chrome.com/docs/extensions/reference/api/tabs#type-ZoomSettings>
```
...
#### Returns
  ...
  - Promise\<[ZoomSettings](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-ZoomSettings)\>  
Chrome 88+  
...
): Promise<https://developer.chrome.com/docs/extensions/reference/windows#type-Window.Window>
```
...
): Promise<https://developer.chrome.com/docs/extensions/reference/api/tabs#type-Tab | Tab[]>
```
...
#### Returns
  ...
  - Promise\<[Tab](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-Tab) \| [Tab](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-Tab)\[\]\>  
Chrome 88+  
...
#### Parameters
  ...
  object  
    ...
    - windowType  
    [WindowType](https://developer.chrome.com/docs/extensions/reference/api/tabs#type-WindowType) optional
...
Fired when a tab is moved within a window. Only one move event is fired, representing the tab the user directly moved. Move events are not fired for the other tabs that must move in response to the manually-moved tab. This event is not fired when a tab is moved between windows; for details, see [`tabs.onDetached`](https://developer.chrome.com/docs/extensions/reference/api/tabs#event-onDetached).  
