...
You must declare the "privacy" permission in your extension's [manifest](https://developer.chrome.com/docs/extensions/mv3/manifest) to use the API. For
example:  
...
| **Note:** Full details about extensions' ability to control `ChromeSetting`s can be found under [`chrome.types.ChromeSetting`](https://developer.chrome.com/docs/extensions/reference/api/types#type-ChromeSetting).
...
#### Properties
  ...
  [types.ChromeSetting](https://developer.chrome.com/docs/extensions/reference/types/#type-ChromeSetting)\<[IPHandlingPolicy](https://developer.chrome.com/docs/extensions/reference/api/privacy#type-IPHandlingPolicy)\>  
  Chrome 48+
