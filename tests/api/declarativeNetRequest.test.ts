...
describe('chrome.declarativeNetRequest', () => {
  ...
  test('getAvailableStaticRuleCount returns a promise that rejects with unimplemented error', async () => {
    await expect(chrome.declarativeNetRequest.getAvailableStaticRuleCount()).rejects.toThrow(
  ...
  test('getDisabledRuleIds throws unimplemented error', () => {
    ...
    ).toThrow('chrome.declarativeNetRequest.getDisabledRuleIds is not implemented')
  })
  ...
  test('getEnabledRulesets returns a promise that rejects with unimplemented error', async () => {
    await expect(chrome.declarativeNetRequest.getEnabledRulesets()).rejects.toThrow(
  ...
  test('getMatchedRules throws unimplemented error', () => {
    ...
    ).toThrow('chrome.declarativeNetRequest.getMatchedRules is not implemented')
  })
  ...
  test('isRegexSupported throws unimplemented error', () => {
    ...
    ).toThrow('chrome.declarativeNetRequest.isRegexSupported is not implemented')
  })
  ...
  test('setExtensionActionOptions throws unimplemented error', () => {
    ...
    ).toThrow('chrome.declarativeNetRequest.setExtensionActionOptions is not implemented')
  })
  ...
  test('testMatchOutcome throws unimplemented error', () => {
    ...
    ).toThrow('chrome.declarativeNetRequest.testMatchOutcome is not implemented')
  })

  test('updateDynamicRules throws unimplemented error', () => {
    expect(() =>
      chrome.declarativeNetRequest.updateDynamicRules(ruleOptions),
    ).toThrow('chrome.declarativeNetRequest.updateDynamicRules is not implemented')
  })
  ...
  test('updateEnabledRulesets throws unimplemented error', () => {
    ...
    ).toThrow('chrome.declarativeNetRequest.updateEnabledRulesets is not implemented')
  })

  test('updateSessionRules throws unimplemented error', () => {
    expect(() =>
      chrome.declarativeNetRequest.updateSessionRules(ruleOptions),
    ).toThrow('chrome.declarativeNetRequest.updateSessionRules is not implemented')
  })
  ...
  test('updateStaticRules throws unimplemented error', () => {
    ...
    ).toThrow('chrome.declarativeNetRequest.updateStaticRules is not implemented')
  })

  test('onRuleMatchedDebug event interface works', () => {
    const listener = () => {}
    chrome.declarativeNetRequest.onRuleMatchedDebug.addListener(listener)
    expect(chrome.declarativeNetRequest.onRuleMatchedDebug.hasListener(listener)).toBe(true)
    expect(chrome.declarativeNetRequest.onRuleMatchedDebug.hasListeners()).toBe(true)
    ...
    expect(chrome.declarativeNetRequest.onRuleMatchedDebug.hasListener(listener)).toBe(false)
  })
})
