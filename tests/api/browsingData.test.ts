...
describe('chrome.browsingData', () => {
  ...
  test('removeCookies throws unimplemented error', () => {
    expect(() => chrome.browsingData.removeCookies(removalOptions)).toThrow(
      'chrome.browsingData.removeCookies is not implemented',
    );
  });

  test('removeDownloads throws unimplemented error', () => {
    expect(() => chrome.browsingData.removeDownloads(removalOptions)).toThrow(
      'chrome.browsingData.removeDownloads is not implemented',
    );
  });

  test('removeFileSystems throws unimplemented error', () => {
    expect(() => chrome.browsingData.removeFileSystems(removalOptions)).toThrow(
      'chrome.browsingData.removeFileSystems is not implemented',
    );
  });

  test('removeFormData throws unimplemented error', () => {
    expect(() => chrome.browsingData.removeFormData(removalOptions)).toThrow(
      'chrome.browsingData.removeFormData is not implemented',
    );
  });

  test('removeHistory throws unimplemented error', () => {
    expect(() => chrome.browsingData.removeHistory(removalOptions)).toThrow(
      'chrome.browsingData.removeHistory is not implemented',
    );
  });

  test('removeIndexedDB throws unimplemented error', () => {
    expect(() => chrome.browsingData.removeIndexedDB(removalOptions)).toThrow(
      'chrome.browsingData.removeIndexedDB is not implemented',
    );
  });
  ...
  test('removePasswords throws unimplemented error', () => {
    expect(() => chrome.browsingData.removePasswords(removalOptions)).toThrow(
      'chrome.browsingData.removePasswords is not implemented',
    );
  });

  test('removePluginData throws unimplemented error', () => {
    expect(() => chrome.browsingData.removePluginData(removalOptions)).toThrow(
      'chrome.browsingData.removePluginData is not implemented',
    );
  });
  ...
  test('removeWebSQL throws unimplemented error', () => {
    expect(() => chrome.browsingData.removeWebSQL(removalOptions)).toThrow(
      'chrome.browsingData.removeWebSQL is not implemented',
    );
  });
