...
#### Properties
  ...
  - source  
  [PrinterSource](https://developer.chrome.com/docs/extensions/reference/api/printingMetrics#type-PrinterSource)
...
#### Properties
  ...
  - printer  
  [Printer](https://developer.chrome.com/docs/extensions/reference/api/printingMetrics#type-Printer)
  ...
  - settings  
  [PrintSettings](https://developer.chrome.com/docs/extensions/reference/api/printingMetrics#type-PrintSettings)

  The settings of the print job.
  - source  
  [PrintJobSource](https://developer.chrome.com/docs/extensions/reference/api/printingMetrics#type-PrintJobSource)
  ...
  - status  
  [PrintJobStatus](https://developer.chrome.com/docs/extensions/reference/api/printingMetrics#type-PrintJobStatus)
...
#### Properties
  ...
  - color  
  [ColorMode](https://developer.chrome.com/docs/extensions/reference/api/printingMetrics#type-ColorMode)
  ...
  - duplex  
  [DuplexMode](https://developer.chrome.com/docs/extensions/reference/api/printingMetrics#type-DuplexMode)

  The requested duplex mode.
  - mediaSize  
  [MediaSize](https://developer.chrome.com/docs/extensions/reference/api/printingMetrics#type-MediaSize)
...
```typescript
chrome.printingMetrics.getPrintJobs(): Promise<https://developer.chrome.com/docs/extensions/reference/api/printingMetrics#type-PrintJobInfo[]>
```
...
#### Returns
  ...
  - Promise\<[PrintJobInfo](https://developer.chrome.com/docs/extensions/reference/api/printingMetrics#type-PrintJobInfo)\[\]\>  
  Chrome 96+
...
#### Parameters
  ...
  <br />
    ...
    - jobInfo  
    [PrintJobInfo](https://developer.chrome.com/docs/extensions/reference/api/printingMetrics#type-PrintJobInfo)
