...
describe('chrome.permissions', () => {
  ...
  test('addHostAccessRequest throws unimplemented error', () => {
    expect(() =>
      chrome.permissions.addHostAccessRequest(hostAccessRequest),
    ).toThrow('chrome.permissions.addHostAccessRequest is not implemented');
  });
  ...
  test('removeHostAccessRequest throws unimplemented error', () => {
    expect(() =>
      chrome.permissions.removeHostAccessRequest(hostAccessRequest),
    ).toThrow('chrome.permissions.removeHostAccessRequest is not implemented');
  });
