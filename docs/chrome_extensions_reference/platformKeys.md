...
): Promise<https://developer.chrome.com/docs/extensions/reference/api/platformKeys#type-Match[]>
```
...
): Promise<https://developer.chrome.com/docs/extensions/reference/api/platformKeys#type-VerificationResult>
```
