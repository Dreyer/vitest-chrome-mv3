...
- Get all available tokens using [`enterprise.platformKeys.getTokens()`](https://developer.chrome.com/docs/extensions/reference/api/enterprise/platformKeys#method-getTokens).
...
#### Properties
  ...
  - registerKey  
  [RegisterKeyOptions](https://developer.chrome.com/docs/extensions/reference/api/enterprise/platformKeys#type-RegisterKeyOptions) optional
  ...
  - scope  
  [Scope](https://developer.chrome.com/docs/extensions/reference/api/enterprise/platformKeys#type-Scope)
...
#### Properties
  ...
  - algorithm  
  [Algorithm](https://developer.chrome.com/docs/extensions/reference/api/enterprise/platformKeys#type-Algorithm)
...
#### Properties
  ...
  Static IDs are `"user"` and `"system"`, referring to the platform's user-specific and the system-wide hardware token, respectively. Any other tokens (with other identifiers) might be returned by [`enterprise.platformKeys.getTokens`](https://developer.chrome.com/docs/extensions/reference/api/enterprise/platformKeys#method-getTokens).
...
#### Parameters
  ...
  - options  
  [ChallengeKeyOptions](https://developer.chrome.com/docs/extensions/reference/api/enterprise/platformKeys#type-ChallengeKeyOptions)

Object containing the fields defined in [`ChallengeKeyOptions`](https://developer.chrome.com/docs/extensions/reference/api/enterprise/platformKeys#type-ChallengeKeyOptions).  
...
Use [`challengeKey`](https://developer.chrome.com/docs/extensions/reference/api/enterprise/platformKeys#method-challengeKey) instead.
...
```typescript
chrome.enterprise.platformKeys.getTokens(): Promise<https://developer.chrome.com/docs/extensions/reference/api/enterprise/platformKeys#type-Token[]>
```
...
#### Returns
  ...
  - Promise\<[Token](https://developer.chrome.com/docs/extensions/reference/api/enterprise/platformKeys#type-Token)\[\]\>  
Chrome 131+  
