...
![Side panel drop-down menu](https://developer.chrome.com/static/docs/extensions/reference/api/sidePanel/images/example-side-panel.png)Chrome browser side panel UI.
...
| **Key point:** Remember to design your side panel as a useful companion tool for users, improving their browsing experience without unnecessary distractions. Check the[Quality Guidelines](https://developer.chrome.com/docs/webstore/program-policies/quality-guidelines)in the Program Policies for more info.
...
![Pin icon in side panel UI.](https://developer.chrome.com/static/docs/extensions/reference/api/sidePanel/images/side-panel-pin.png)Pin icon in side panel UI.
...
#### Properties
  ...
  - side  
[Side](https://developer.chrome.com/docs/extensions/reference/api/sidePanel#type-Side)  
...
```typescript
chrome.sidePanel.getLayout(): Promise<https://developer.chrome.com/docs/extensions/reference/api/sidePanel#type-PanelLayout>
```
...
- Promise\<[PanelLayout](https://developer.chrome.com/docs/extensions/reference/api/sidePanel#type-PanelLayout)\>  
...
): Promise<https://developer.chrome.com/docs/extensions/reference/api/sidePanel#type-PanelOptions>
```
...
```typescript
chrome.sidePanel.getPanelBehavior(): Promise<https://developer.chrome.com/docs/extensions/reference/api/sidePanel#type-PanelBehavior>
```
...
#### Parameters
  ...
  <br />
    ...
    - info  
    [PanelOpenedInfo](https://developer.chrome.com/docs/extensions/reference/api/sidePanel#type-PanelOpenedInfo)
