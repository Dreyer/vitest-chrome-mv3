...
#### Properties
  ...
  - position  
  [LayoutPosition](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-LayoutPosition)
...
#### Properties
  ...
  If set, updates the display's logical bounds origin along the x-axis. Applied together with [`boundsOriginY`](https://developer.chrome.com/docs/extensions/reference/api/system/display#property-DisplayProperties-boundsOriginY). Defaults to the current value if not set and [`boundsOriginY`](https://developer.chrome.com/docs/extensions/reference/api/system/display#property-DisplayProperties-boundsOriginY) is set. Note that when updating the display origin, some constraints will be applied, so the final bounds origin may be different than the one set. The final bounds can be retrieved using [`getInfo`](https://developer.chrome.com/docs/extensions/reference/api/system/display#method-getInfo). The bounds origin cannot be changed on the primary display.
  - boundsOriginY  
  number optional

  If set, updates the display's logical bounds origin along the y-axis. See documentation for [`boundsOriginX`](https://developer.chrome.com/docs/extensions/reference/api/system/display#property-DisplayProperties-boundsOriginX) parameter.
  - displayMode  
  [DisplayMode](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-DisplayMode) optional  
  Chrome 52+
  ...
  If set to true, makes the display primary. No-op if set to false. Note: If set, the display is considered primary for all other properties (i.e. [`isUnified`](https://developer.chrome.com/docs/extensions/reference/api/system/display#property-DisplayProperties-isUnified) may be set and bounds origin may not).
  - isUnified  
  boolean optional  
  Chrome 59+

  ChromeOS only. If set to true, changes the display mode to unified desktop (see [`enableUnifiedDesktop`](https://developer.chrome.com/docs/extensions/reference/api/system/display#method-enableUnifiedDesktop) for details). If set to false, unified desktop mode will be disabled. This is only valid for the primary display. If provided, mirroringSourceId must not be provided and other properties will be ignored. This is has no effect if not provided.
  - mirroringSourceId  
  string optional  
  Deprecated since Chrome 68

  Use [`setMirrorMode`](https://developer.chrome.com/docs/extensions/reference/api/system/display#method-setMirrorMode).
  ...
  - overscan  
  [Insets](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-Insets) optional
...
#### Properties
  ...
  - activeState  
  [ActiveState](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-ActiveState)  
  Chrome 117+
  ...
  - bounds  
  [Bounds](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-Bounds)
  ...
  - edid  
  [Edid](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-Edid) optional  
  Chrome 67+
  ...
  True for all displays when in unified desktop mode. See documentation for [`enableUnifiedDesktop`](https://developer.chrome.com/docs/extensions/reference/api/system/display#method-enableUnifiedDesktop).
  ...
  - modes  
  [DisplayMode](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-DisplayMode)\[\]  
  Chrome 52+
  ...
  - overscan  
  [Insets](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-Insets)
...
If set to true, only a single [`DisplayUnitInfo`](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-DisplayUnitInfo) will be returned by [`getInfo`](https://developer.chrome.com/docs/extensions/reference/api/system/display#method-getInfo) when in unified desktop mode (see [`enableUnifiedDesktop`](https://developer.chrome.com/docs/extensions/reference/api/system/display#method-enableUnifiedDesktop)). Defaults to false.  
...
#### Properties
  ...
  - mode  
  [MirrorMode](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-MirrorMode)
...
#### Properties
  ...
  - displayPoint  
  [Point](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-Point)
...
#### Properties
  ...
  - pair1  
  [TouchCalibrationPair](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-TouchCalibrationPair)
...
#### Parameters
  ...
  - pairs  
  [TouchCalibrationPairQuad](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-TouchCalibrationPairQuad)
...
```typescript
chrome.system.display.getDisplayLayout(): Promise<https://developer.chrome.com/docs/extensions/reference/api/system/display#type-DisplayLayout[]>
```
...
#### Returns
  ...
  - Promise\<[DisplayLayout](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-DisplayLayout)\[\]\>  
Chrome 91+  
...
  flags?: GetInfoFlags,
): Promise<https://developer.chrome.com/docs/extensions/reference/api/system/display#type-DisplayUnitInfo[]>
```
...
#### Parameters
  ...
  - flags  
  [GetInfoFlags](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-GetInfoFlags) optional  
  Chrome 59+
...
#### Returns
  ...
  - Promise\<[DisplayUnitInfo](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-DisplayUnitInfo)\[\]\>  
Chrome 91+  
...
#### Parameters
  ...
  - layouts  
  [DisplayLayout](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-DisplayLayout)\[\]
...
#### Parameters
  ...
  The display's unique identifier.
  - info  
  [DisplayProperties](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-DisplayProperties)
...
#### Parameters
  ...
  - info  
  [MirrorModeInfo](https://developer.chrome.com/docs/extensions/reference/api/system/display#type-MirrorModeInfo)
