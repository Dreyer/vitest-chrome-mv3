...
in the [extension manifest](https://developer.chrome.com/docs/extensions/reference/manifest). For example:  
...
There is no defined ordering between events of the [webRequest API](https://developer.chrome.com/docs/extensions/reference/api/webRequest) and the events of the
...
pre-rendered. Such tabs are not accessible using the [tabs API](https://developer.chrome.com/docs/extensions/reference/api/tabs) nor can you request information
...
just *frameIds* . We are introducing a concept of a [documentId](https://developer.chrome.com/docs/extensions/reference/webNavigation#method-getFrame:%7E:text=retrieve%20information%20about.-,documentId,-string%C2%A0optional)
...
property. The *transition type* is the same as used in the [history API](https://developer.chrome.com/docs/extensions/reference/api/history#transition_types) describing how the
...
#### Parameters
  ...
  <br />
    ...
    object  
      ...
      [TransitionQualifier](https://developer.chrome.com/docs/extensions/reference/api/webNavigation#type-TransitionQualifier)\[\]

      A list of transition qualifiers.
      - transitionType  
      [TransitionType](https://developer.chrome.com/docs/extensions/reference/api/webNavigation#type-TransitionType)
